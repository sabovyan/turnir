...
// rest.forEach((round) => {
//   round.games.forEach(async (game) => {
//     const pair = await this.gameService.getGamesByNextGameId({
//       id: game.id,
//     });
...
//     // console.log({
//     //   first: pairFirstGame.id,
//     //   firstStatus: pairFirstGame.isCompleted,
//     //   second: pairSecondGame.id,
//     //   secondStatus: pairSecondGame.isCompleted,
//     //   secondPosition: pairSecondGame.nextGamePosition,
//     //   firstPosition: pairFirstGame.nextGamePosition,
//     // });
...
//       }
//     }
//     const currentUpdatedGame = await this.gameService.getById({
//       id: game.id,
//     });

//     if (
//       !currentUpdatedGame.participant1Id ||
//       !currentUpdatedGame.participant2Id
//     ) {
//       await this.gameService.updateGameCompletionStatus({
//         id: game.id,
//       });
//     }
//   });
